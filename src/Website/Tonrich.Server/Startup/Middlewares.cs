...
using Tonrich.Server.Components;
...
public class Middlewares
{
    public static void Use(WebApplication app, IHostEnvironment env, IConfiguration configuration)
    {
        ...
        app.MapRazorComponents<App>()
            ...
            .AddAdditionalAssemblies(AssemblyLoadContext.Default.Assemblies.Where(asm => asm.GetName().Name?.Contains("Tonrich") is true).Except([Assembly.GetExecutingAssembly()]).ToArray());
    }
